 ...
 * @description: TbsX5
 * <p>
 * 腾讯 X5 需要先下载在加载 速度快 体积小 建议优先使用
 */
public class TbsX5WebActivity extends AppCompatActivity implements ReaderCallback {
    ...
    private String mFileUrl = "http://www.cals.uidaho.edu/edComm/curricula/CustRel_curriculum/content/sample.pdf";
    private String mFileName;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tbs_x5_web);
    ...
    private void queryDownloadStatus() {
        ...
        try {
            ...
            if (cursor != null && cursor.moveToFirst()) {
                ...
                String str = "正在下载：" + currentBytes + "/" + totalBytes;
                mDownloadBtn.setText(str);
